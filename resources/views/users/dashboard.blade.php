...
@section('css')
    <style class="css">
        ...
        .deposit-balance-div .balance-name{
      ...
      .rep-img{
        ...
        .balance-divs.all-time-balance-div::after{
         ...
         .balance-divs.deposit-balance-div::after{
            content:'';
            position:absolute;
            right:10%;
            bottom:10%;
...
{{-- WALLETS --}}
     ...
     <div style="background:red" class="wallets deposit"></div>
       ...
       {{-- TEMPLATES --}}
       {{-- DEPOSIT BALANCE TEMPLATE --}}
       <template class="deposit-wallet">
        <div onclick="
...
{{-- WALLETS --}}
     ...
     <div style="background:yellow" class="wallets all_time"></div>
      <div style="background:white" class="wallets deposit"></div>
       </div>
...
{{-- WALLETS --}}
     ...
     <div style="background:white" class="wallets all_time"></div>
     <div style="background:blue" class="wallets deposit"></div>
       </div>
      </template>
