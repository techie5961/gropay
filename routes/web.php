...
Route::prefix('users')->group(function(){
   Route::middleware([UsersAuthCheckerMiddleware::class])->group(function(){
    ...
    Route::get('ball/game',[
        UsersDashboardController::class,'BallGame'
    ]);
    Route::get('logout',[
...
//    prefix get
   Route::prefix('get')->group(function(){
    ...
    Route::get('debit/user/for/ball/game',[
        UsersGetRequestController::class,'DebitUserForBallGame'
    ]);
    Route::get('credit/user/ball/game',[
        UsersGetRequestController::class,'CreditUserForBallGame'
    ]);
